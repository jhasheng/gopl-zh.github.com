...
在Plan9操作系统中，这些优秀的想法被吸收到了一个叫\[Alef\]\[Alef\]的编程语言中。Alef试图将Newsqueak语言改造为系统编程语言，但是因为缺少垃圾回收机制而导致并发编程很痛苦。（译注：在Alef之后还有一个叫\[Limbo\]\[Limbo\]的编程语言，Go语言从其中借鉴了很多特性。 具体请参考Pike的讲稿：[http://talks.golang.org/2012/concurrency.slide\#9](http://talks.golang.org/2012/concurrency.slide#9) ）
